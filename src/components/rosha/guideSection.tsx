    ...
    const steps: Array<{ number: number; title: string; description?: string }> = [
        {
            number: 1,
            title:
                'در سایت جی‌جی‌دکتر با شماره موبایلی که در شرکت صباایده ثبت شده است (همان شماره‌ای که در دیتابیس شرکت موجود است) ثبت‌نام کنید.',
        ...
        },
        {
            ...
            description: 'در این مرحله تعداد ایمپلینت هایی که مطمئن هستید نیاز دارید را خریداری نمایید. در صورتی که پس از ویزیت دکتر، احتیاج به خرید تعداد بیشتر داشتید امکان خرید مجدد برای شما فراهم خواهد بود.',
        },
        {
            number: 3,
        ...
        },
        {
            ...
            description:
                'اما اگر ۴ عدد یا بیشتر انتخاب کرده‌اید، لازم است ابتدا نزد آقای علی طلوعی مراجعه کرده و یک سفته ضمانتی امضا کنید. سفته‌ها از قبل در واحد مالی آماده هستند و نیازی به تهیه سفته توسط شما نیست. پس از امضا، کدهای مربوط به تعداد ایمپلنت درخواستی برایتان پیامک خواهد شد.',
        },
        {
            number: 5,
            title:
