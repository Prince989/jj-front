...
const AddToCart: React.FC<AddToCartProps> = ({ isOpen }) => {
    ...
    return (
        <div
            className={`w-full bg-[#EDF7FF] rounded-2xl shadow-md p-6 flex flex-col gap-8 rtl ${isOpen ? 'flex' : 'hidden overflow-hidden'} transition-all duration-300`}
            style={{ fontFamily: 'YekanBakh', direction: 'rtl' }}
        >
            <div className='w-[90%] bg-transparent mx-auto lg:p-6 rounded-lg'>
                {/* Title */}
