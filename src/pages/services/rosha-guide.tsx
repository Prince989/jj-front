...
const RoshaGuide = () => {
    ...
    const steps = [
        ...
        },
        {
            ...
            description: 'تعداد ایمپلنت‌هایی را که قصد دارید در یک سال آینده برای خود یا اعضای خانواده استفاده کنید، انتخاب نمایید و دکمه "خرید ایمپلنت" را انتخاب کنید تا وارد فرآیند خرید شوید.',
        },
        {
            number: 3,
            title: 'انتخاب تعداد ایمپلنت مطابق با نیاز شما',
            description: 'تعداد ایمپلنت مورد نیاز خود را انتخاب کنید و به مرحله پرداخت بروید.',
        },
        {
            number: 4,
        ...
        {
            number: 6,
            title: 'پس از دریافت پیامک، به لینک « دریافت نوبت » مراجعه و شماره پیگیری را به مشاور ارسال نمایید',
            description: 'پس از دریافت پیامک، به لینک "دریافت نوبت" مراجعه کنید و شماره پیگیری دریافتی را به مشاور ارسال نمایید.',
        },
        {
            number: 7,
